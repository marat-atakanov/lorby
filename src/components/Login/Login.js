...
function Login() {
    ...
    return (
        <form onSubmit={(e) => {
            ...
            <Button type={"submit"} text={"Войти"} isLoading={isLoading} margin={"48px 0 0"}/>
            {/*<Button type={"button"} onClick={()=>ApiClient().logout()} text={"Выйти"} margin={"48px 0 0"} lightTheme={false}/>*/}
            <Button type={"button"} onClick={()=>navigate("/register")} text={"У меня еще нет аккаунта"} margin={"48px 0 0"} lightTheme={true}/>
